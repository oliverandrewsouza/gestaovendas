...
INSERT INTO produto (descricao, quantidade, preco_custo, preco_venda, observacao, codigo_categoria) values ('Fogão Elétrico De Mesa', 8, 60.80, 106.80, 'Fogão Elétrico De Mesa 2 Pratos 2000 Watts Agrato 220v', 4);
INSERT INTO produto (descricao, quantidade, preco_custo, preco_venda, observacao, codigo_categoria) values ('Fogão 4 Bocas', 20, 280.50, 424.86, 'Fogão 4 Bocas Atlas Mônaco Com Acendimento Automático', 4);
INSERT INTO produto (descricao, quantidade, preco_custo, preco_venda, observacao, codigo_categoria) values ('Fogão 5 Bocas', 30, 864, 1164.94, 'Fogão 5 Bocas Tripla Chama Automático Agile Glass Inox Atlas', 4);
...
INSERT INTO produto (descricao, quantidade, preco_custo, preco_venda, observacao, codigo_categoria) values ('Relógio Technos Masculino Dourado', 35, 180, 249, 'Relógio Technos Masculino Dourado Performer - 2115laa/4c', 5);
INSERT INTO produto (descricao, quantidade, preco_custo, preco_venda, observacao, codigo_categoria) values ('Relógio Nibosi Cronógrafo', 50, 100, 160.50, 'Relógio Nibosi Cronógrafo Fr Grátis Promoção Carnaval', 5);
INSERT INTO produto (descricao, quantidade, preco_custo, preco_venda, observacao, codigo_categoria) values ('Anel Maciço Ouro 18k', 60, 210, 299.90, 'Anel Solitario Maciço Ouro 18k 750 7mm Escolha A Cor', 5);
